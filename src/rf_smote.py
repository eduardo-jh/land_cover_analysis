...
Changelog:
  ...
  2024-05-13: SMOTE implementation
"""
...
def landcover_classification(cwd, stats_dir, pheno_dir, fn_landcover, fn_mask, fn_tiles, **kwargs):
    ...
    _oversampling = kwargs.get("oversampling", False)
    ...
    if _oversampling is not False:
        # Override read and split when oversampling
        _read_split = False
    ...
    #=============================================================================
    # Read feature datasets, split with SMOTE oversampling technique
    #=============================================================================
