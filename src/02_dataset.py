...
Eduardo Jimenez <eduardojh@email.arizona.edu>
  ...
  Mar  7, 2023: split dataset into hdf5 datasets
...
# Features: spectral bands, vegetation indices, and phenologic parameters
...
# TODO: do this with h5py to avoid creating an on-memory array
...
for j, band in enumerate(bands):
    ...
    for i, month in enumerate(months):
        ...
        #     layer += 1
print(f'Existing files: {file_exist}, Missing: {file_notexist}, Total: {file_exist+file_notexist}')
