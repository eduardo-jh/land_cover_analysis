...
fn_training_mask  = cwd + 'training/usv250s7cw_ROI1_train_mask_all.tif'
...
max_trials = 50000  # max of attempts to fill the sample size
...
while (i < max_trials and completed_samples < len(completed.keys())):
    ...
    # ws = raster_arr[win_row_ini:win_row_end,win_col_ini:win_col_end]
    # print(ws)
