...
write.csv(df, paste0(period, "_accuracy_summary_calakmul.csv"))
...
# save CSV
write.csv(mat_df,
          paste0(period, "_accuracy_summary_matrix_calakmul.csv"),
          row.names = FALSE)
